...
subsequently removing, TXT records using the Namecheap REST API.
...
========================================  =====================================
``--dns-namecheap-credentials``           Namecheap Remote API credentials_
                                          INI file. (Required)
...
Use of this plugin requires a configuration file containing Namecheap Remote API
...
.. code-block:: ini
   ...
   dns_namecheap_username = myispremoteuser
   dns_namecheap_password = mysecretpassword
   dns_namecheap_endpoint = https://localhost:8080
...
.. code-block:: bash
   ...
   certbot certonly \\
     --dns-namecheap \\
     --dns-namecheap-credentials ~/.secrets/certbot/namecheap.ini \\
     --dns-namecheap-propagation-seconds 240 \\
     -d example.com
